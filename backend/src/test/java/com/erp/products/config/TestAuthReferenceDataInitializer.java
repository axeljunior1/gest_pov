...
public class TestAuthReferenceDataInitializer implements ApplicationRunner {
    ...
    private void seedPermissions() {
        List<String[]> defs = List.of(
                ...
                new String[]{"sales.cancellations.read", "Consulter les ventes annulees", "MODULE_ANALYTICS"},
                new String[]{"sales.cancellations.detail", "Detail ventes annulees", "MODULE_ANALYTICS"},
                new String[]{"sales.cancellations.audit", "Audit annulations vente", "MODULE_ANALYTICS"},
