...
public class AuthReferenceDataInitializer implements ApplicationRunner {
    ...
    private void seedRoles() {
        ...
        saveRole("Manager", "MANAGER",
                "Gestion catalogue, stock et entrees", true, filter(all,
                "products.read", "products.create", "products.update", "products.validate", "products.delete",
                "product_variant.read", "product_variant.create", "product_variant.update", "product_variant.delete",
                "product_variant.manage_stock", "product_variant.manage_packaging",
                "product_packaging.update_price",
                ...
                "pos.sale.cancel", "pos.sale.discount", "pos.sale.validate_discount", "pos.sale.refund",
                "pos.ticket.reprint", "pos.report.read",
    ...
    private List<PermissionDef> allPermissionDefs() {
        return List.of(
                ...
                p("pos.sale.validate_discount", "Valider une remise au-dela du seuil autorise", "MODULE_POS"),
