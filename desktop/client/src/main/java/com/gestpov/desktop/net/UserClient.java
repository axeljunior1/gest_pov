...
public class UserClient {
    ...
    public UserAccount create(String firstName, String lastName, String email, String password,
                              boolean active, List<Long> roleIds) throws ApiException {
        return UserAccount.fromJson(api.post("/api/users", body(firstName, lastName, email, password, active, roleIds)));
    }
    ...
    public UserAccount update(long id, String firstName, String lastName, String email, String password,
        ...
        return UserAccount.fromJson(api.put("/api/users/" + id,
                body(firstName, lastName, email, password, active, roleIds)));
    }
