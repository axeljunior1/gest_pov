...
const PATTERN_MESSAGES = [
  ...
  { test: /stock insuffisant/i, map: () => 'Stock insuffisant — réduisez la quantité ou vérifiez le stock disponible.' },
  { test: /produit.*inactif|non vendable|non disponible/i, map: () => 'Ce produit n\'est pas disponible à la vente.' },
  { test: /aucun produit trouve|aucun produit trouvé/i, map: () => 'Aucun produit trouvé — vérifiez le nom, le SKU ou le code-barres.' },
  ...
  { test: /installation/i, map: (m) => m },
  { test: /licence|license/i, map: (m) => m },
  { test: /fichier licence/i, map: (m) => m },
