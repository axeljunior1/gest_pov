...
export const productsApi = {
  ...
  updateVariant: (id, variantId, data) => api.put(`/products/${id}/variants/${variantId}`, data).then(r => r.data),
  generateVariants: (id, data) => api.post(`/products/${id}/variants/generate`, data).then(r => r.data),
...
export const variantAttributesApi = {
  list: (activeOnly = false) => api.get('/variant-attributes', { params: { activeOnly } }).then(r => r.data),
  get: (id) => api.get(`/variant-attributes/${id}`).then(r => r.data),
  create: (data) => api.post('/variant-attributes', data).then(r => r.data),
  update: (id, data) => api.put(`/variant-attributes/${id}`, data).then(r => r.data),
  delete: (id) => api.delete(`/variant-attributes/${id}`),
  addValue: (id, data) => api.post(`/variant-attributes/${id}/values`, data).then(r => r.data),
}
...
export const posApi = {
  ...
  listClosedSessions: (params) => api.get('/pos/sessions/closed', { params }).then(r => r.data),
  ...
  scanItem: (id, data) => api.post(`/pos/sales/${id}/scan`, data).then(r => r.data),
  ...
  holdCount: () => api.get('/pos/sales/hold/count').then(r => r.data.count),
  listDraft: () => api.get('/pos/sales/draft').then(r => r.data),
  ...
  searchRefundableSales: (q, limit) => api.get('/pos/sales/refundable/search', { params: { q, limit } }).then(r => r.data),
  returnableSale: (id) => api.get(`/pos/sales/${id}/returnable`).then(r => r.data),
  createReturn: (saleId, data) => api.post(`/pos/sales/${saleId}/returns`, data).then(r => r.data),
  validateReturn: (returnId, data) => api.post(`/pos/returns/${returnId}/validate`, data).then(r => r.data),
  getReturn: (id) => api.get(`/pos/returns/${id}`).then(r => r.data),
  returnReceipt: (id) => api.get(`/pos/returns/${id}/receipt`).then(r => r.data),
